...
public class FormularioManutencaoProduto extends javax.swing.JFrame {
    ...
    public FormularioManutencaoProduto() {
        initComponents();
        try {
            subSistemaProduto = new SubSistemaProduto();
...
private void botaoExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoExcluirActionPerformed
    ...
    FormularioExcluirProduto tela = new FormularioExcluirProduto();
...
private void campoFiltroNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_campoFiltroNomeActionPerformed
    ...
    public void atualizaTabela() {
        ...
        try{
            listaLinha = subSistemaProduto.pesquisaProdutoParteNome(filtro);
            listaLinha = subSistemaProduto.calcularPrecoVenda(listaLinha);
