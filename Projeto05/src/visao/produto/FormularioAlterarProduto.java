...
import negocio.SubSistemaProduto;
...
public class FormularioAlterarProduto extends JDialog {
    ...
    private SubSistemaProduto subSistemaProduto;

    public FormularioAlterarProduto(int codigo) {
        this.codigoProduto = codigo;
        initComponents();
        try {
            this.subSistemaProduto = new SubSistemaProduto();
    ...
    private void confirmaOperacao() {
        ...
        try {
            ...
            this.subSistemaProduto.alterarProduto(produtoVO);
    ...
    private void preecheCampos() {
        try {
            ProdutoVO produtoVO = this.subSistemaProduto.pesquisaProdutoCodigo(codigoProduto);
            ...
            this.comboGrupoProduto.setModel(new DefaultComboBoxModel(this.subSistemaProduto.buscarTodosGruposProdutos().toArray()));
